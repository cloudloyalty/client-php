...
class CalculationQueryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CloudLoyalty\\Api\\Model\\CalculationQuery';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CloudLoyalty\\Api\\Model\\CalculationQuery';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CloudLoyalty\Api\Model\CalculationQuery();
        if (property_exists($data, 'client')) {
            $object->setClient($this->denormalizer->denormalize($data->{'client'}, 'CloudLoyalty\\Api\\Model\\ClientQuery', 'json', $context));
        }
        ...
        if (property_exists($data, 'rows')) {
            ...
            foreach ($data->{'rows'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CloudLoyalty\\Api\\Model\\CalculationQueryRow', 'json', $context);
            }
