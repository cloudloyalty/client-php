...
class GetBalancePostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'client')) {
            $object->setClient($this->denormalizer->denormalize($data->{'client'}, 'CloudLoyalty\\Api\\Model\\ClientInfo', 'json', $context));
        }
        ...
        if (property_exists($data, 'bonuses')) {
            ...
            foreach ($data->{'bonuses'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CloudLoyalty\\Api\\Model\\GetBalancePostResponse200BonusesItem', 'json', $context);
            }
