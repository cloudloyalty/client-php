...
class NewClientPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CloudLoyalty\\Api\\Generated\\Model\\NewClientPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CloudLoyalty\\Api\\Generated\\Model\\NewClientPostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CloudLoyalty\Api\Generated\Model\NewClientPostBody();
        if (property_exists($data, 'client')) {
            $object->setClient($this->denormalizer->denormalize($data->{'client'}, 'CloudLoyalty\\Api\\Generated\\Model\\ClientInfoQuery', 'json', $context));
        }
