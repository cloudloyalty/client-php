...
class ClientInfoReplyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CloudLoyalty\\Api\\Generated\\Model\\ClientInfoReply';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CloudLoyalty\\Api\\Generated\\Model\\ClientInfoReply';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CloudLoyalty\Api\Generated\Model\ClientInfoReply();
        ...
        if (property_exists($data, 'children')) {
            ...
            foreach ($data->{'children'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'CloudLoyalty\\Api\\Generated\\Model\\ClientInfoReplyChildrenItem', 'json', $context);
            }
