...
class CalculationResultRowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CloudLoyalty\\Api\\Generated\\Model\\CalculationResultRow';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CloudLoyalty\\Api\\Generated\\Model\\CalculationResultRow';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \CloudLoyalty\Api\Generated\Model\CalculationResultRow();
        ...
        if (property_exists($data, 'discounts')) {
            $object->setDiscounts($this->denormalizer->denormalize($data->{'discounts'}, 'CloudLoyalty\\Api\\Generated\\Model\\CalculationResultDiscounts', 'json', $context));
        }
        if (property_exists($data, 'bonuses')) {
            $object->setBonuses($this->denormalizer->denormalize($data->{'bonuses'}, 'CloudLoyalty\\Api\\Generated\\Model\\CalculationResultRowBonuses', 'json', $context));
        }
        if (property_exists($data, 'offers')) {
            $values = [];
            foreach ($data->{'offers'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CloudLoyalty\\Api\\Generated\\Model\\CalculationResultRowOffersItem', 'json', $context);
            }
